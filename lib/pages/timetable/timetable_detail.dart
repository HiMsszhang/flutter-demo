        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.end,
              children: [
                Image.asset('assets/images/timetable/icon_reward.png', width: 50.w, height: 48.w),
                SizedBox(width: 40.w),
                ...List.generate(
                  3,
                  (index) => Container(
                ...
                SizedBox(width: 16.w),
                Text('未完成', style: Styles.normalFont(fontSize: 28.sp, color: Styles.color999999, height: 1.2)),
              ],
            ),
          ),
          Container(
