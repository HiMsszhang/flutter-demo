...
class _MineRewardDetailPageState extends State<MineRewardDetailPage> with UtilsMixin {
  InviteRewardListResp _data = new InviteRewardListResp();
  List<InviteRewardModel> _dataList = [];
  ...
  Future<List<InviteRewardModel>> _getList() async {
    DataResult result = await InviteAPI.rewardList(
      page: _page,
      listRow: _listRow,
    );
    _data = result.data;
